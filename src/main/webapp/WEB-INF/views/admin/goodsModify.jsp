			...
			<form action="/admin/goodsModify" method="post" id="modifyForm">
				<div class="form_section">
					...
					<div class="form_section_content">
						<input name="shipName" value="${goodsInfo.shipName}"> <span
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input name="shipPrice" value="${goodsInfo.shipPrice}"> <span
							class="ck_warn shipPrice_warn">상품 가격을 입력해주세요.</span>
					</div>
				</div>
				<div class="form_section">
					<div class="form_section_title">
					...
					<div class="form_section_content">
						<input name="shipStock" value="${goodsInfo.shipStock}"> <span
							class="ck_warn shipStock_warn">상품 재고를 입력해주세요.</span>
					</div>
				</div>
				...
				<div class="form_section">
					...
					<div class="form_section_content bit">
						<textarea name="shipIntro" id="shipIntro_textarea">${goodsInfo.shipIntro}</textarea>
						<span class="ck_warn shipIntro_warn">책 소개를 입력해주세요.</span>
					</div>
				</div>
				<div class="form_section">
					<div class="form_section_title">
